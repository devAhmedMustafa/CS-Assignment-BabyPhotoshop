...
2.  #### Bloom
    ...
    2.  Iterate on each pixel
        1.  Check if any channel of the pixel colors is greater than the
            threshold
            1.  pixel \[r\] = min(255, pixel\[r\] \* intensity + blurred
                \[r\])
            2.  pixel \[g\] = min(255, pixel\[g\] \* intensity + blurred
                \[g\])
            3.  pixel \[b\] = min(255, pixel\[b\] \* intensity + blurred
                \[b\])
